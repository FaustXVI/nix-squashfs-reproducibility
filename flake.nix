          ...
          let
            script = pkgs.writeShellScriptBin "create-non-reproducible-squashfs"
              ''
                ...
                ${pkgs.squashfsTools}/bin/mksquashfs myaws $FILE -no-hardlinks -keep-as-directory -all-root -b 1048576 -comp gzip -Xcompression-level 1 -processors 1 -root-mode 0755 -no-compression > /dev/null
